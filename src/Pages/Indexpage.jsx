...
import Sodaimage from '../assets/images/soda-2.webp'
import Header from '../components/Header'
import Section_Banner from '../assets/images/Section_2_Banner.png'
...
const Indexpage = () => {
  ...
  return (
    <div className='relative cursor-default'>
      ...
      <div ref={containerRef}>
        <div className='bg-[#FE5E33] h-[100dvh] md:h-[95dvh] overflow-hidden relative'>
          ...
          <div className='absolute hidden md:block top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-center'>
            <h1 className='text-[100px] sm:text-[150px] md:text-[180px] lg:text-[220px] xl:text-[280px] text-white text-right-entry' style={{ fontFamily: 'OntrobucjDemo, sans-serif' }}>REGULAR</h1>
          </div>
          ...
          <div className='absolute hidden md:flex top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex-col gap-0 items-center z-50 text-center'>
            <h1 className='text-[70px] sm:text-[60px] md:text-[100px] lg:text-[130px] xl:text-[140px] text-white text-left-entry' style={{ fontFamily: 'OntrobucjDemo, sans-serif' }}>FU*K</h1>
            <div className='h-[45px] sm:h-[100px] md:h-[180px] lg:h-[220px] xl:h-[240px]' />
            <h1 className='text-[70px] sm:text-[60px] md:text-[100px] lg:text-[130px] xl:text-[140px] text-white text-left-entry' style={{ fontFamily: 'OntrobucjDemo, sans-serif' }}>SODA</h1>
          </div>
        </div>
      </div>

      {/* Section 2 - Marquee */}
      <div className='overflow-hidden whitespace-nowrap border-b-2 border-[#8a8a8a] h-[100px] bg-white'>
        <div className='marquee-strip inline-block whitespace-nowrap mt-5 text-black text-3xl font-semibold tracking-wide' ref={stripRef}>
          {[...Array(2)].map((_, outerIdx) => (
            <span key={outerIdx}>
              {Array(10).fill("Ancient Ingredients. Futuristic Fuel.").map((text, i) => (
      ...
      {/* Section 4 - Features */}
      <div className='container mx-auto px-5 pt-8 flex flex-col gap-3 md:gap-6 items-center justify-center'>
        <h1 style={{ fontFamily: 'OntrobucjDemo, sans-serif' }} className='text-[#374B9F] text-3xl md:text-6xl font-bold text-center'>From Cravings. Built Without Compromise.</h1>
